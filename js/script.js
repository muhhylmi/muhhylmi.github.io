...
ikon.forEach(a=>{
	...
	a.addEventListener('mouseleave', ()=>{
		mouseCursor.style.cssText ='transform:scale(1); transition:transform .5s ease; background-color:transparent; opacity:1;';
	});
})
...
button.addEventListener('mouseleave', ()=>{
	mouseCursor.style.cssText ='transform:none; transition:all .5s ease; background-color:transparent; opacity:1;';
});
